...
class BosListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by BosParser#preprocessor.
	enterPreprocessor(ctx) {
	}

	// Exit a parse tree produced by BosParser#preprocessor.
	exitPreprocessor(ctx) {
	}
	...
	// Enter a parse tree produced by BosParser#pieceDec.
	enterPieceDec(ctx) {
	}

	// Exit a parse tree produced by BosParser#pieceDec.
	exitPieceDec(ctx) {
	}


	// Enter a parse tree produced by BosParser#staticVarDec.
	enterStaticVarDec(ctx) {
	}

	// Exit a parse tree produced by BosParser#staticVarDec.
	exitStaticVarDec(ctx) {
	}


	// Enter a parse tree produced by BosParser#funcDec.
	enterFuncDec(ctx) {
	}

	// Exit a parse tree produced by BosParser#funcDec.
	exitFuncDec(ctx) {
	}
	...
	// Exit a parse tree produced by BosParser#incrementStatement.
	exitIncrementStatement(ctx) {
	}


	// Enter a parse tree produced by BosParser#decrementStatement.
	enterDecrementStatement(ctx) {
	}

	// Exit a parse tree produced by BosParser#decrementStatement.
	...
	enterStartStatement(ctx) {
	}

	// Exit a parse tree produced by BosParser#startStatement.
	exitStartStatement(ctx) {
	}


	// Enter a parse tree produced by BosParser#spinStatement.
	enterSpinStatement(ctx) {
	}

	// Exit a parse tree produced by BosParser#spinStatement.
	exitSpinStatement(ctx) {
	}


	// Enter a parse tree produced by BosParser#optionalAcceleration.
	enterOptionalAcceleration(ctx) {
	}

	// Exit a parse tree produced by BosParser#optionalAcceleration.
	exitOptionalAcceleration(ctx) {
	}


	// Enter a parse tree produced by BosParser#stopSpinStatement.
	enterStopSpinStatement(ctx) {
	}

	// Exit a parse tree produced by BosParser#stopSpinStatement.
	exitStopSpinStatement(ctx) {
	}


	// Enter a parse tree produced by BosParser#optionalDeceleration.
	enterOptionalDeceleration(ctx) {
	}

	// Exit a parse tree produced by BosParser#optionalDeceleration.
	exitOptionalDeceleration(ctx) {
	}


	// Enter a parse tree produced by BosParser#turnStatement.
	enterTurnStatement(ctx) {
	}

	// Exit a parse tree produced by BosParser#turnStatement.
	exitTurnStatement(ctx) {
	}


	// Enter a parse tree produced by BosParser#moveStatement.
	enterMoveStatement(ctx) {
	}
	...
	// Enter a parse tree produced by BosParser#globalConstant.
	enterGlobalConstant(ctx) {
	}

	// Exit a parse tree produced by BosParser#globalConstant.
	...
	// Enter a parse tree produced by BosParser#funcCall.
	enterFuncCall(ctx) {
	}

	// Exit a parse tree produced by BosParser#funcCall.
	exitFuncCall(ctx) {
	}


	// Enter a parse tree produced by BosParser#randCall.
	enterRandCall(ctx) {
	}

	// Exit a parse tree produced by BosParser#randCall.
	exitRandCall(ctx) {
	}


	// Enter a parse tree produced by BosParser#commaExpression.
	enterCommaExpression(ctx) {
	}

	// Exit a parse tree produced by BosParser#commaExpression.
	exitCommaExpression(ctx) {
	}
	...
	// Enter a parse tree produced by BosParser#signedIntegerConstant.
	enterSignedIntegerConstant(ctx) {
	}

	// Exit a parse tree produced by BosParser#signedIntegerConstant.
	exitSignedIntegerConstant(ctx) {
	}


	// Enter a parse tree produced by BosParser#signedFloatConstant.
	enterSignedFloatConstant(ctx) {
	}

	// Exit a parse tree produced by BosParser#signedFloatConstant.
	exitSignedFloatConstant(ctx) {
	}



}
module.exports = BosListener;
